...
//event emitter to send for retrieving the password
...
//event emitter to send the welcome email after successful registration
eventEmitter.on('welcome-mail',  (data)=> {
	...
	let mailOptions = {
        ...
        html: `<p>Hello ${data.firstName} ${data.lastName},
	        	Thank You for registering.
	        	Looking forward to having a great journey with you.
	        	</p>` // plain text body // plain text body
        	};
        	...
        	transporter.sendMail(mailOptions,  (err, info)=> {
        		if (err)
        			...
        			console.log("Welcome Mail successfully sent" + info);
        	});
        });
